...
#the code in below that i find from this link.
regex = re.compile(
...
def explanation(x):
    ...
    message = ["Continue","Switching Protocols","Proccessing","OK","Created","Accepted", "Non-Authoritative Information","No Content", "Reset Content","Partial Content","Multi-Status","Content Different","Multiple Choises","Moved Permanently","See Other","Not Modified","Use Proxy","Temporary Redirect","Bad Request","Unauthorized","Payment Required","Forbidden","Not Found","Nonaccess","Not Acceptable","Needed Proxy","Time-out","Conflict","Gone","Length Required","Precondition Failed","Request Entity Too Large","Request-URI Too Long","Unsupported Media Type","Requested Range Unstatifiable","Expectation Failed","Unprocessable Entity","Loced","Method Failure","Internal Server Error","Unapplied","Bad Gateway","No Service","Gateway Timeout","HTTP Version not Supported"]
